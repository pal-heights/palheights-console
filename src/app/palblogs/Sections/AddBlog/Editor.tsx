      ...
      <div className={styles.modal} onMouseDown={(e) => e.stopPropagation()}>
        ...
        <div className={styles.modalBody}>
          ...
          <input
            ...
            onKeyDown={handleKeyDown}
            placeholder="https://pub-jsdfksj.r2.dev/image.webp"
            spellCheck={false}
          />
...
export default function Editor({ editorRef, onUpdate }: EditorProps) {
  ...
  const editor = useEditor({
    ...
    onUpdate({ editor }) {
      syncToolbar(editor);
      const w = editor.storage.characterCount?.words() ?? 0;
      const c = editor.storage.characterCount?.characters() ?? 0;
      setWords(w);
      setChars(c);
      onUpdate?.(c > 0);
    },
